...
bool ParticleShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, SimpleMath::Matrix worldMatrix, SimpleMath::Matrix viewMatrix,
	SimpleMath::Matrix projectionMatrix, ID3D11ShaderResourceView* texture)
{
	bool result;
...
bool ParticleShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, SimpleMath::Matrix worldMatrix, SimpleMath::Matrix viewMatrix,
	SimpleMath::Matrix projectionMatrix, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
