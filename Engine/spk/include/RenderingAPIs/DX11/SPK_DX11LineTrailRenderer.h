...
#ifndef H_SPK_DX11LINETRAILRENDERER
#define H_SPK_DX11LINETRAILRENDERER
...
namespace DX11
{
	...
	class SPK_DX11_PREFIX DX9LineTrailRenderer : public DX11Renderer
	{
	...
	private :
		...
		static SimpleMath::Vector3* vertexBuffer;
		static SimpleMath::Vector3* vertexIterator;
		static SimpleMath::Color* colorBuffer;
		static SimpleMath::Color* colorIterator;
		static float* valueBuffer;
		static float* valueIterator;

		static ID3D11Buffer* DX9VertexBuffer;
		static ID3D11Buffer* DX9ColorBuffer;
	...
	{
		DX11Renderer::enableBlending(true);
	}
	...
	inline void DX9LineTrailRenderer::init(const Particle& particle,float age) const
	{
		...
		{
			*(vertexIterator++) = SimpleMath::Vector3(pos.x, pos.y, pos.z);
		}
