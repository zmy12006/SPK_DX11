...
#include "RenderingAPIs/DX11/Math/QK3DQuaternion.h"

#define CLAMP(x , min , max) ((x) > (max) ? (max) : ((x) < (min) ? (min) : x))

// void QK3DQuaternion::set(const Vector3& axis, float angle)
// {
// 	createFromAxisAngle(axis, angle, this);
// }
// 
// void QK3DQuaternion::set(Matrix& m)
// {
// 	createFromRotationMatrix(m, this);
// }
// 
// void QK3DQuaternion::set(const Vector3& angle)
// {
...
// }
// 
// Vector3 QK3DQuaternion::GetEulerAngle()
// {
// 	Vector3 ret;
// 
// 	float test = y*z + x*w;
...
// }
// 
// void QK3DQuaternion::createFromAxisAngle(const Vector3& axis, float angle, Quaternion* dst)
// {
...
// }
// 
// void QK3DQuaternion::createFromRotationMatrix( Matrix& m, Quaternion* dst)
// {
// 	//m.getRotation(dst);
// 	Vector3 s;
// 	Vector3 t;
...
Quaternion QK3DQuaternion::CreateFromAxisAngle(const Vector3& axis, float angle)
{
...
Quaternion QK3DQuaternion::CreateFromYawPitchRoll(float yaw, float pitch, float roll)
{
	using namespace DirectX;
	Quaternion R;
...
Quaternion QK3DQuaternion::CreateFromRotationMatrix(const Matrix& M)
{
	using namespace DirectX;
...
void QK3DQuaternion::GetAxisAngle(const Quaternion& q, Vector3& axis, float& angle)
{
	using namespace DirectX;
...
Quaternion QK3DQuaternion::SetEulerAngle(float yaw, float pitch, float roll)
{
...
Vector3 QK3DQuaternion::GetEulerAngle(Quaternion q)
{
	Vector3 v;
